...
%The executive state of the traffic light.
...
%Change the traffic light state. This method is used internally by public methods to 
%change the traffic light behaviour.
