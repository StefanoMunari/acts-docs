...
In the following we list the qualities which our system should have to
...
The way we abstracted city traffic brings new issues whose solution
...
operation are delivered to the aforementioned garage. Clearly,
